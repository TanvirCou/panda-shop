...
const AllWithdraw = () => {
  ...
  const fetchAllWithdraw = async () => {
    ...
    try {
      const res = await axios.get(
        "https://panda-shop-server-production-v2.up.railway.app/api/withdraw/get-all-withdraw-request",
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axios.put(
        `https://panda-shop-server-production-v2.up.railway.app/api/withdraw//update-withdraw-request/${withdrawData._id}`,
