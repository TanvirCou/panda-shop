  ...
  const handleDelete = async (e) => {
    ...
    try {
      const res = await axios.delete(
        `https://panda-shop-server-production-v2.up.railway.app/api/shop/delete-shop/${shopId}`,
                  ...
                  >
                    ...
                    <td className='px-5 py-3.5'>
                      <span className='font-bold text-gray-800'>
                        ${shop.availableBalance?.toFixed(2) || "0.00"}
                      </span>
                    </td>
                    <td className='px-5 py-3.5'>
              ...
              <div className='flex flex-col items-center gap-4 text-center pt-2'>
                ...
                <div>
                  ...
                  <p className='text-sm text-gray-400 mt-1'>
                    This action cannot be undone. All shop data will be
                    permanently removed.
                  </p>
                </div>
