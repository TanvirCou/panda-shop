        ...
        <div className="p-4 md:p-6 space-y-5">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-400 font-medium">{users.length} registered users</p>
                </div>
            </div>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {filtered.map((user, index) => (
                                    <tr key={index} className="hover:bg-gray-50/60 transition-colors duration-150">
                                        ...
                                        <td className="px-5 py-3.5 text-gray-400 text-xs">{user?.phoneNumber || "—"}</td>
                                        <td className="px-5 py-3.5">
                ...
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[150] flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-sm p-6 relative">
                        ...
                        <div className="flex flex-col items-center gap-4 text-center pt-2">
                            ...
                            <div>
                                <h3 className="text-base font-black text-gray-900">Delete User?</h3>
                                <p className="text-sm text-gray-400 mt-1">This action cannot be undone. The user account will be permanently removed.</p>
                            </div>
