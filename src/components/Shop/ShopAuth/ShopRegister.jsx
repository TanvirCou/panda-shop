...
const ShopRegister = ({ setActive }) => {
    ...
    if (password !== confirmPassword) {
      ...
      try {
        ...
        const res = await axios.post(
          "https://panda-shop-server-v3.up.railway.app/api/shop/shop-register",
          data
        );
  ...
  const inputClass =
    "w-full h-11 bg-white border border-gray-200 rounded-xl pl-10 pr-4 text-sm font-medium text-gray-800 placeholder:text-gray-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition-all duration-200";
      ...
      <div className='space-y-1.5'>
        ...
        <div className='flex items-center gap-4 p-3 bg-white border border-gray-200 rounded-xl shadow-sm'>
          ...
          <label
            ...
            className='flex items-center gap-2 cursor-pointer text-sm font-semibold text-cyan-600 hover:text-cyan-500 transition-colors'
          >
