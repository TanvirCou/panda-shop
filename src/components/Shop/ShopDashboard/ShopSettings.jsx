  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await axios.put(
        "https://panda-shop-server-v4.up.railway.app/api/shop/update-shop-info",
        {
          name,
          description,
          address,
    ...
    <div className='p-4 md:p-6'>
      <div className='mb-6'>
        ...
        <p className='text-sm text-gray-400 mt-0.5'>
          Update your shop's public profile and contact info
        </p>
      </div>
              ...
              <div className='flex items-center gap-5'>
                ...
                <div>
                  ...
                  <p className='text-xs text-gray-400 mt-0.5'>
                    Click the camera icon to change your shop photo
                  </p>
                  {uploading && (
                    <p className='text-xs text-amber-500 font-semibold mt-1 animate-pulse'>
                      Uploading…
                    </p>
                  )}
                  {avatarUrl && !uploading && (
          ...
          <div className='space-y-4'>
            ...
            <div className='bg-cyan-50 border border-cyan-100 rounded-xl px-4 py-3'>
              ...
              <p className='text-xs text-cyan-500 mt-1 leading-relaxed'>
                A complete profile with a logo and description helps build
                customer trust and improves your shop's visibility.
              </p>
            </div>
