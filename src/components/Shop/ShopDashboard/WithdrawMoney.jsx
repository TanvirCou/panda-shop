...
const WithdrawMoney = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(
        "https://panda-shop-server-production-v2.up.railway.app/api/shop/update-payment-methods",
        { bankInfo },
  ...
  const handleDelete = async (e) => {
    ...
    try {
      await axios.delete(
        "https://panda-shop-server-production-v2.up.railway.app/api/shop/delete-withdraw-method",
        { withCredentials: true }
      );
  ...
  const handleWithdraw = async (e) => {
    ...
    try {
      await axios.post(
        "https://panda-shop-server-production-v2.up.railway.app/api/withdraw/create-withdraw-request",
