...
const CouponCode = () => {
  ...
  const fetchCouponCodes = async () => {
    ...
    try {
      const res = await axios.get(
        `https://panda-shop-server-v4.up.railway.app/api/coupon-code/all-coupon-codes/${shop.shop._id}`,
  ...
  const handleDelete = async (id) => {
    try {
      const res = await axios.delete(
        `https://panda-shop-server-v4.up.railway.app/api/coupon-code/delete-coupon-code/${id}`,
        { withCredentials: true }
      );
  ...
  const handleCreate = async (e) => {
    ...
    try {
      await axios.post(
        "https://panda-shop-server-v4.up.railway.app/api/coupon-code/create-coupon-code",
        {
          name,
          value,
          minAmount,
