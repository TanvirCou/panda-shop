            ...
            <div className="w-full top-0 left-0 relative z-[110]">
                <div className="hidden md:flex items-center justify-between bg-white h-[70px] md:px-12 border-b border-gray-100 shadow-sm">
                    ...
                    <div className="w-[48%] relative">
                        ...
                        {search && (
                            <div className="absolute top-[calc(100%+6px)] left-0 right-0 z-[120] bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                                {searchData && searchData.length !== 0 ? (
                                    searchData.map((i, index) => (
                                        <Link to={`/product/${i._id}`} key={index}>
                                            <div className="flex items-center gap-3 px-4 py-3 hover:bg-emerald-50 transition-colors duration-150 border-b border-gray-50 last:border-0">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center w-8 h-8 rounded-xl hover:bg-gray-100 transition-colors duration-200"
                            >
                        ...
                        <div className="px-4 py-3 border-b border-gray-50">
                            ...
                            {search && (
                                <div className="mt-1 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden max-h-[35vh] overflow-y-auto">
                                    {searchData && searchData.length !== 0 ? (
                                        searchData.map((i, index) => (
                                            <Link to={`/product/${i._id}`} key={index}>
                                                <div className="flex items-center gap-3 px-3 py-2.5 hover:bg-emerald-50 border-b border-gray-50 last:border-0">
                                                    <img src={i?.images[0]} alt="" className="w-9 h-9 rounded-lg object-cover flex-shrink-0" />
                                                    <p className="text-sm text-gray-700 font-medium truncate">{i?.name}</p>
                                                </div>
                                            </Link>
                                        ...
                                        <div className="flex items-center gap-2 px-3 py-3.5 text-gray-400">
                        ...
                        <div className="p-4 border-t border-gray-100 space-y-3">
                            ...
                            <button
                                ...
                                className="flex items-center gap-3 w-full px-4 py-2.5 rounded-xl hover:bg-gray-50 transition-colors duration-200"
                            >
                                <div className="relative">
                            ...
                            <Link to="/shop-auth">
                                <div className="flex items-center justify-between bg-gray-900 hover:bg-gray-700 rounded-xl px-4 py-2.5 cursor-pointer transition-colors duration-200">
                                    <p className="text-sm font-semibold text-white">
                                        {shop && shop?.shop ? "Go to Shop" : "Become Seller"}
                                    </p>
                                    <IoIosArrowForward size={13} className="text-gray-400" />
                                </div>
                            </Link>
