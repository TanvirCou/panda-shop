...
const Checkout = () => {
  ...
  const handleCode = async (e) => {
    ...
    const res = await axios.get(
      `https://panda-shop-server-v4.up.railway.app/api/coupon-code/get-coupon-value/${name}`
    );
  ...
  const paypalPaymentHandler = async (paymentInfo) => {
    ...
    try {
      const res = await axios.post(
        "https://panda-shop-server-v4.up.railway.app/api/order/create-order",
        order
      );
  ...
  const paymentHandler = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://panda-shop-server-v4.up.railway.app/api/payment/process",
        paymentData
      );
