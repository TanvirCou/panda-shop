    ...
    useEffect(() => {
        if (token) {
            const activationId = async () => {
                try {
                    await axios.post(
                        "https://panda-shop-server-production.up.railway.app/api/user/activation",
            ...
            <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100 p-8 text-center transition-all duration-300">
                {loading ? (
                    <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-xl font-black text-gray-900 tracking-tight">Activating Account</h2>
                            <p className="text-sm text-gray-400 mt-1 font-medium">Please wait while we verify your token...</p>
                        </div>
                    </div>
                ) : error ? (
                    <div className="flex flex-col items-center">
                        ...
                        <h2 className="text-2xl font-black text-gray-900 tracking-tight">Token Expired</h2>
                        <p className="text-gray-500 mt-3 font-medium leading-relaxed">
                            It looks like your activation link has expired or is invalid. Please try signing up again.
                        </p>
                        <Link
                            to="/auth"
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <h2 className="text-2xl font-black text-gray-900 tracking-tight">Account Activated!</h2>
                        <p className="text-gray-500 mt-3 font-medium leading-relaxed">
                            Welcome to <span className="text-emerald-500 font-bold">PandaShop</span>. Your account has been successfully created and is ready for use.
                        </p>
                        <Link
                            to="/auth"
