      ...
      <div className="relative z-10 bg-white rounded-3xl shadow-xl border border-gray-100 p-10 max-w-md w-full text-center">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-5">
            ...
            <div>
              <h1 className="text-xl font-black text-gray-900">Activating Your Shop…</h1>
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div>
              <h1 className="text-2xl font-black text-gray-900">Activation Failed</h1>
              <p className="text-sm text-gray-400 mt-2 leading-relaxed">
                Your activation link has expired or is invalid. Please register again to get a new link.
              </p>
            </div>
            <button
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            <div>
              <h1 className="text-2xl font-black text-gray-900">Shop Activated!</h1>
              <p className="text-sm text-gray-400 mt-2 leading-relaxed">
                Congratulations! Your shop has been successfully created and is ready to start selling.
              </p>
            </div>
            ...
            <div className="w-full grid grid-cols-3 gap-3 text-center">
              {[
                ...
                <div key={label} className="bg-cyan-50 rounded-xl p-3 flex flex-col items-center gap-1">
                  <span className="text-xl">{emoji}</span>
                  <p className="text-[11px] font-semibold text-cyan-700">{label}</p>
                </div>
              ))}
            </div>
