...
const ShopForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post('https://panda-shop-server-production.up.railway.app/api/shop/forgot-password', { email });
            setSent(true);
        } catch (err) {
        ...
        <div className="fixed inset-0 w-full h-full flex overflow-hidden">
            ...
            <div className="hidden lg:flex lg:w-[46%] xl:w-[42%] flex-col justify-between bg-gradient-to-br from-cyan-600 via-sky-500 to-cyan-700 p-12 relative overflow-hidden flex-shrink-0 h-full">
                ...
                <div className="relative z-10">
                    <Link to="/" className="text-2xl font-black text-white tracking-tight">
                        ...
                        <span className="ml-2 text-xs font-bold bg-white/20 text-white px-2 py-0.5 rounded-full align-middle">Seller</span>
                    </Link>
                </div>
                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <h2 className="text-4xl xl:text-5xl font-extrabold text-white leading-tight tracking-tight">
                        Forgot your<br /><span className="text-cyan-100">password?</span>
                    </h2>
                    <p className="text-sky-100/80 text-base leading-relaxed max-w-xs">
                        No worries — we'll send a secure reset link to your registered email address.
                    </p>
                </div>
            ...
            <div className="flex-1 h-full overflow-y-auto flex flex-col items-center bg-gray-50 px-6 py-12 sm:px-10">
                ...
                <div className="w-full max-w-[440px] my-auto">
                    ...
                    <Link to="/shop-auth" className="inline-flex items-center gap-1.5 text-sm font-semibold text-gray-400 hover:text-cyan-600 transition-colors mb-6">
                    ...
                    {sent ? (
                        ...
                        <div className="text-center space-y-4 py-8">
                            <div className="w-16 h-16 mx-auto rounded-2xl bg-cyan-50 flex items-center justify-center text-3xl">
                                📬
                            </div>
                            ...
                            <p className="text-xs text-gray-300 pt-2">
                                Didn't receive it?{' '}
                                <button onClick={() => { setSent(false); setEmail(''); }} className="text-cyan-500 hover:text-cyan-600 font-semibold transition-colors">
                                    Try again
                                </button>
                            </p>
                        </div>
                        ...
                        <>
                            ...
                            <div className="mb-7">
                                ...
                                <p className="text-sm text-gray-400 mt-1">Enter your shop's email and we'll send you a reset link.</p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div>
                                    ...
                                    <div className="relative">
                                        <IoMailOutline size={16} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none" />
                                        <input
                                            type="email"
                                            value={email}
                                            ...
                                            className="w-full h-11 pl-10 pr-4 bg-white border border-gray-200 rounded-xl text-sm text-gray-800 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-400/40 focus:border-cyan-400 shadow-sm transition-all duration-200"
                                        />
                                    </div>
                                </div>
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full h-11 bg-gradient-to-r from-cyan-600 to-sky-500 hover:from-cyan-500 hover:to-sky-400 disabled:opacity-60 text-white text-sm font-bold rounded-xl shadow-md hover:shadow-lg hover:shadow-cyan-200/50 transition-all duration-300 active:scale-[0.98]"
                                >
