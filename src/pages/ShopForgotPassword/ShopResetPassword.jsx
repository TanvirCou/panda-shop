        ...
        <div>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    minLength={6}
                    className="w-full h-11 pl-10 pr-10 bg-white border border-gray-200 rounded-xl text-sm text-gray-800 placeholder:text-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-400/40 focus:border-cyan-400 shadow-sm transition-all duration-200"
                />
                <button
                    type="button"
...
const ShopResetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await axios.post(`https://panda-shop-server-production.up.railway.app/api/shop/reset-password/${token}`, { password, confirmPassword });
            setDone(true);
            setTimeout(() => navigate('/shop-auth'), 3000);
        } catch (err) {
            ...
            <div className="hidden lg:flex lg:w-[46%] xl:w-[42%] flex-col justify-between bg-gradient-to-br from-cyan-600 via-sky-500 to-cyan-700 p-12 relative overflow-hidden flex-shrink-0 h-full">
                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <h2 className="text-4xl xl:text-5xl font-extrabold text-white leading-tight tracking-tight">
                        Set a new<br /><span className="text-cyan-100">password.</span>
                    </h2>
                    <p className="text-sky-100/80 text-base leading-relaxed max-w-xs">
                        Choose a strong password with at least 6 characters to keep your seller account secure.
                    </p>
                </div>
                    ...
                    {done ? (
                        <div className="text-center space-y-4 py-8">
                            ...
                            <p className="text-sm text-gray-400 leading-relaxed">
                                Your seller account password has been reset successfully.<br />
