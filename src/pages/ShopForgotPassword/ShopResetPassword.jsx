...
const ShopResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        `https://panda-shop-server-production-v2.up.railway.app/api/shop/reset-password/${token}`,
      ...
      <div className='hidden lg:flex lg:w-[46%] xl:w-[42%] flex-col justify-between bg-gradient-to-br from-cyan-600 via-sky-500 to-cyan-700 p-12 relative overflow-hidden flex-shrink-0 h-full'>
        ...
        <div className='relative z-10 space-y-4'>
          ...
          <h2 className='text-4xl xl:text-5xl font-extrabold text-white leading-tight tracking-tight'>
            Set a new
            <br />
            <span className='text-cyan-100'>password.</span>
          </h2>
      ...
      <div className='flex-1 h-full overflow-y-auto flex flex-col items-center bg-gray-50 px-6 py-12 sm:px-10'>
        <div className='lg:hidden mb-8 text-center'>
          ...
          >
            ...
            <span className='ml-2 text-xs font-bold bg-cyan-100 text-cyan-600 px-2 py-0.5 rounded-full align-middle'>
              Seller
            </span>
          </Link>
        </div>
        ...
        <div className='w-full max-w-[440px] my-auto'>
          <Link
            to='/shop-auth'
            className='inline-flex items-center gap-1.5 text-sm font-semibold text-gray-400 hover:text-cyan-600 transition-colors mb-6'
          >
          ...
          {done ? (
            <div className='text-center space-y-4 py-8'>
              ...
              <p className='text-sm text-gray-400 leading-relaxed'>
                Your seller account password has been reset successfully.
                <br />
