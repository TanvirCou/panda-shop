...
function App() {
  ...
  const getStripeApiKey = async () => {
    const res = await axios.get(
      "https://panda-shop-server-production-v3.up.railway.app/api/payment/stripe-api-key"
    );
  ...
  //  const getUser = async() => {
  //   try {
  //     const res = await axios.get("https://panda-shop-server-production-v3.up.railway.app/api/user/get", {withCredentials: true});
